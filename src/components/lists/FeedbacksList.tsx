import CLIENT1 from '../../assets/Sumer_Johal.png'
import CLIENT2 from '../../assets/Lance_Kohler.jpeg'

export const FEEDBACK_LIST = [
  {
    avatar: CLIENT1,
    name: "Sumer Johal",
    organiztion: "Executive Director @ Linux Foundation",
    social: "https://www.linkedin.com/in/sumer-s-johal-748730",
  ...
  },
  {
    avatar: CLIENT2,
    name: "Lance Kohler",
    organiztion: "Customer Success Manager @ ModMed",
    social: "https://www.linkedin.com/in/lckohler",
